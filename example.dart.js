...
"%":"Blob|DOMError|DOMImplementation|DOMParser|File|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|Range|SQLError|SVGAnimatedNumberList|SVGAnimatedString"},
yE:{
"^":"Gv;",
...
T9:[function(a){return J.v1(a)},"$1","rm",2,0,13],
...
y=new W.JQ(y)
y.qR(a)
return y},qD:[function(a,b,c,d){return!0},"$4","y3",8,0,20],QW:[function(a,b,c,d){var z,y,x,w,v
z=d.gKs()
y=z.Q
x=J.RE(y)
x.sLU(y,c)
...
"^":"a;Q,a",
wR:function(a,b){var z,y,x
z=H.J(new P.Z(H.J(new P.vs(0,$.V,null),[null])),[null])
y=this.a.j1(65535)
x=this.Q
C.QH.v0(x,"message",new M.ew(this,z,y),!1)
x.postMessage(P.B(["workerHandle",y,"payload",b],null,null))
return z.Q}},
ew:{
"^":"r:12;Q,a,b",
...
z=J.Qd(a)
y=J.t(z)
if(!!y.$isw&&J.mG(y.p(z,"workerHandle"),this.b)){C.QH.Ci(this.Q.Q,"message",this,!1)
x=this.a
if(z.x4("error")===!0)x.pm(y.p(z,"error"))
else x.aM(0,y.p(z,"payload"))}}}}],["","",,U,{
"^":"",
W:function(a,b,c,d){return a.Q.wR(0,P.B(["source",b,"format",J.Mz(C.Nm.grZ(c.X(0).split("."))),"engine",J.Mz(C.Nm.grZ(d.X(0).split("."))),"options",null],null,null)).Rx(new U.m6(c),new U.F0())},
E2:[function(){var z,y
z=new S.N(new M.M(new Worker("packages/graphviz/graphviz.js"),C.X))
y=new S.N(new M.M(new Worker("packages/graphviz/graphviz.js"),C.X))
...
U.W(z,"digraph G { bgcolor=\"purple:pink\" label=\"agraph\" fontcolor=\"white\"\n  subgraph cluster1 {fillcolor=\"blue:cyan\" label=\"acluster\" fontcolor=\"white\" style=\"filled\" gradientangle=\"270\"\n    node [shape=box fillcolor=\"red:yellow\" style=\"filled\" gradientangle=90]\n    anode;\n  }\n}\n",C.S,C.AQ).Z(new U.em())
U.W(y,"graph G {\n    run -- intr;\n    intr -- runbl;\n    runbl -- run;\n    run -- kernel;\n    kernel -- zombie;\n    kernel -- sleep;\n    kernel -- runmem;\n    sleep -- swap;\n    swap -- runswap;\n    runswap -- new;\n    runswap -- runmem;\n    new -- runmem;\n    sleep -- runmem;\n}\n",C.S,C.P).Z(new U.Lb())
U.W(z,"digraph G {\n\n  subgraph cluster_0 {\n    style=filled;\n    color=lightgrey;\n    node [style=filled,color=white];\n    a0 -> a1 -> a2 -> a3;\n    label = \"process #1\";\n  }\n\n  subgraph cluster_1 {\n    node [style=filled];\n    b0 -> b1 -> b2 -> b3;\n    label = \"process #2\";\n    color=blue\n  }\n  start -> a0;\n  start -> b0;\n  a1 -> b3;\n  b2 -> a3;\n  a3 -> a0;\n  a3 -> end;\n  b3 -> end;\n\n  start [shape=Mdiamond];\n  end [shape=Msquare];\n}\n",C.T,C.AQ).Z(new U.QA())
U.W(y,"digraph G {\n\n  subgraph cluster_0 {\n    style=filled;\n    color=lightgrey;\n    node [style=filled,color=white];\n    a0 -> a1 -> a2 -> a3;\n    label = \"process #1\";\n  }\n\n  subgraph cluster_1 {\n    node [style=filled];\n    b0 -> b1 -> b2 -> b3;\n    label = \"process #2\";\n    color=blue\n  }\n  start -> a0;\n  start -> b0;\n  a1 -> b3;\n  b2 -> a3;\n  a3 -> a0;\n  a3 -> end;\n  b3 -> end;\n\n  start [shape=Mdiamond];\n  end [shape=Msquare];\n}\n",C.Bp,C.AQ).Z(new U.Cv())},"$0","lS",0,0,0],
m6:{
"^":"r:2;Q",
$1:function(a){var z,y
if(this.Q===C.S){z=new DOMParser().parseFromString(a,"text/xml")
return document.importNode(z.documentElement,!0)}else{y=W.r3("pre",null)
J.Yt(y,a)
return y}}},
F0:{
"^":"r:2;",
...
L:{
"^":"r:2;",
$1:function(a){var z=document.body;(z&&C.RY).Ty(z,"beforeend","<h1>Cluster (svg output)</h1>")
document.body.appendChild(a)}},
Q:{
"^":"r:2;",
$1:function(a){var z=document.body;(z&&C.RY).Ty(z,"beforeend","<h1>Crazy (svg output)</h1>")
document.body.appendChild(a)}},
O:{
"^":"r:2;",
$1:function(a){var z=document.body;(z&&C.RY).Ty(z,"beforeend","<h1>Data Structures (svg output)</h1>")
document.body.appendChild(a)}},
Y:{
"^":"r:2;",
$1:function(a){var z=document.body;(z&&C.RY).Ty(z,"beforeend","<h1>Tables (svg output)</h1>")
document.body.appendChild(a)}},
em:{
"^":"r:2;",
$1:function(a){var z=document.body;(z&&C.RY).Ty(z,"beforeend","<h1>Gradients (svg output)</h1>")
document.body.appendChild(a)}},
Lb:{
"^":"r:2;",
$1:function(a){var z=document.body;(z&&C.RY).Ty(z,"beforeend","<h1>Process States (svg output, neato engine)</h1>")
document.body.appendChild(a)}},
QA:{
"^":"r:2;",
$1:function(a){var z=document.body;(z&&C.RY).Ty(z,"beforeend","<h1>Cluster (plain output)</h1>")
document.body.appendChild(a)}},
Cv:{
"^":"r:2;",
$1:function(a){var z=document.body;(z&&C.RY).Ty(z,"beforeend","<h1>Cluster (xdot output)</h1>")
document.body.appendChild(a)}}},1],["","",,S,{
"^":"",
SF:{
"^":"a;Q",
...
J.Mz=function(a){return J.U(a).hc(a)}
...
init.metadata=[];init.types=[{func:""},{func:"",void:true},{func:"",args:[,]},{func:"",args:[,P.I]},{func:"",args:[P.I]},{func:"",args:[{func:"",void:true}]},{func:"",args:[,],opt:[,]},{func:"",ret:P.a2},{func:"",args:[,,]},{func:"",args:[P.wv,,]},{func:"",ret:P.I,args:[P.KN]},{func:"",void:true,args:[W.KV,W.KV]},{func:"",args:[W.cx]},{func:"",ret:P.KN,args:[,]},{func:"",args:[P.KN]},{func:"",args:[P.KN,,]},{func:"",void:true,args:[{func:"",void:true}]},{func:"",ret:P.a2,args:[,,]},{func:"",ret:P.a2,args:[P.a,P.a]},{func:"",ret:P.KN,args:[P.a]},{func:"",ret:P.a2,args:[W.cv,P.I,P.I,W.JQ]},];$=null
